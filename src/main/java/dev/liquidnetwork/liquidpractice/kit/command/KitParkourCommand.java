...
@CommandMeta(label={"kit parkour"}, permission = "practice.admin")
public class KitParkourCommand {
    public void execute(Player player, @CPL("kit") Kit kit) {
        if (kit == null) {
            ...
            kit.save();
            player.sendMessage(CC.translate("&7Updated parkour mode for &b" + kit.getName() +  " &7to &b" + (kit.getGameRules().isParkour() ? "true!" : "false!")));
